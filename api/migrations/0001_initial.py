    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employes', to='api.company')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pointings', to='api.code')),
                ('employe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pointings', to='api.employe')),
            ],
        ),
    ]
